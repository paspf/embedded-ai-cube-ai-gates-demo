...
#ifndef AI_MODEL_XNOR_GATE_H
#define AI_MODEL_XNOR_GATE_H
#pragma once

#include "model_xnor_gate_config.h"
#include "ai_platform.h"

/******************************************************************************/
#define AI_MODEL_XNOR_GATE_MODEL_NAME          "model_xnor_gate"
#define AI_MODEL_XNOR_GATE_ORIGIN_MODEL_NAME   "xnorgate"

/******************************************************************************/
#define AI_MODEL_XNOR_GATE_ACTIVATIONS_ALIGNMENT   (4)
#define AI_MODEL_XNOR_GATE_INPUTS_IN_ACTIVATIONS   (4)
#define AI_MODEL_XNOR_GATE_OUTPUTS_IN_ACTIVATIONS  (4)

/******************************************************************************/
#define AI_MODEL_XNOR_GATE_IN_NUM        (1)

AI_DEPRECATED
#define AI_MODEL_XNOR_GATE_IN \
  ai_model_xnor_gate_inputs_get(AI_HANDLE_NULL, NULL)

#define AI_MODEL_XNOR_GATE_IN_SIZE { \
  AI_MODEL_XNOR_GATE_IN_1_SIZE, \
}
#define AI_MODEL_XNOR_GATE_IN_SIZE_BYTES { \
  AI_MODEL_XNOR_GATE_IN_1_SIZE_BYTES, \
}
#define AI_MODEL_XNOR_GATE_IN_1_CHANNEL     (2)
#define AI_MODEL_XNOR_GATE_IN_1_SIZE        (2)
#define AI_MODEL_XNOR_GATE_IN_1_SIZE_BYTES  (8)

/******************************************************************************/
#define AI_MODEL_XNOR_GATE_OUT_NUM       (1)

AI_DEPRECATED
#define AI_MODEL_XNOR_GATE_OUT \
  ai_model_xnor_gate_outputs_get(AI_HANDLE_NULL, NULL)

#define AI_MODEL_XNOR_GATE_OUT_SIZE { \
  AI_MODEL_XNOR_GATE_OUT_1_SIZE, \
}
#define AI_MODEL_XNOR_GATE_OUT_SIZE_BYTES { \
  AI_MODEL_XNOR_GATE_OUT_1_SIZE_BYTES, \
}
#define AI_MODEL_XNOR_GATE_OUT_1_CHANNEL     (1)
#define AI_MODEL_XNOR_GATE_OUT_1_SIZE        (1)
#define AI_MODEL_XNOR_GATE_OUT_1_SIZE_BYTES  (4)

/******************************************************************************/
#define AI_MODEL_XNOR_GATE_N_NODES (4)


AI_API_DECLARE_BEGIN

/*!
 * @defgroup model_xnor_gate
 ...
 * @ref ai_model_xnor_gate_create. Both the activations memory buffer 
 ...
 * using @ref ai_model_xnor_gate_get_error
 */
AI_API_ENTRY
 ...
 */
AI_API_ENTRY
ai_buffer* ai_model_xnor_gate_inputs_get(
 ...
 */
AI_API_ENTRY
ai_buffer* ai_model_xnor_gate_outputs_get(
  ai_handle network, ai_u16 *n_buffer);
 ...
 * header generated by the code generation tool. See AI_MODEL_XNOR_GATE_*
 * defines into file @ref model_xnor_gate.h for all network sizes defines
 *
 * @param network an opaque handle to the network context
 ...
 */
AI_API_ENTRY
ai_i32 ai_model_xnor_gate_forward(
  ai_handle network, const ai_buffer* input);

AI_API_DECLARE_END

#endif /* AI_MODEL_XNOR_GATE_H */
